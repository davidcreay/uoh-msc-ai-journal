...
\title{Responsible Technology 1}  % use \\ here otherwise you get a justified title
                                     % note capitalization of the title (only common 
                                     % words in lower case)
\tagline{Ethical considerations of an AI topic}      % tag line *OPTIONAL*
\author{David Reay}            % your full name
\authorID{dr25aar}                   % your University Identifier
\supervisor{Indrel Doney}           % your supervisor(s) name
%\cosupervisor{Dr Who}                % your cosupervisor(s) name - no . in Dr *OPTIONAL*
                                     % simply comment out the above line if absent
\department{School of Physics, Engineering and Computer Science}   % your department (e.g. Artificial Intelligence)
\faculty{Faculty of Computer Science}       % your faculty (e.g. ICT)
\degreeName{M.Sc.\ in Artificial Intelligence}       % the degree you are reading
